<div class="min-h-screen w-80 flex items-center flex-col py-4">
  <a href="{{ route('admin.index') }}">
    <h1 class="w-full px-9 text-2xl font-semibold">SisUKM</h1>
  </a>
  <nav class="w-full flex flex-col gap-y-2 p-6">
    <a href="{{ route('admin.user.index') }}" class="w-full flex gap-x-2 p-3 group hover:bg-blue-50 rounded-md">
    ...
    <a href="{{ route('admin.club.index') }}" class="w-full flex gap-x-2 p-3 group hover:bg-blue-50 rounded-md">
    ...
    <a href="{{ route('admin.documentation.index') }}" class="w-full flex gap-x-2 p-3 group hover:bg-blue-50 rounded-md">
      <svg xmlns="http://www.w3.org/2000/svg" class="fill-current {{ request()->routeIs('admin.documentation.*') ? 'text-blue-600' : 'text-neutral-700' }} group-hover:text-blue-600 w-6 h-6" viewBox="0 -960 960 960">
        <path d="M360-400h400L622-580l-92 120-62-80-108 140Zm-40 160q-33 0-56.5-23.5T240-320v-480q0-33 23.5-56.5T320-880h480q33 0 56.5 23.5T880-800v480q0 33-23.5 56.5T800-240H320Zm0-80h480v-480H320v480ZM160-80q-33 0-56.5-23.5T80-160v-560h80v560h560v80H160Zm160-720v480-480Z" />
      </svg>
      <span class="{{ request()->routeIs('admin.documentation.*') ? 'text-blue-600' : 'text-neutral-700' }} group-hover:text-blue-600">Dokumentasi</span>
    </a>
  </nav>
